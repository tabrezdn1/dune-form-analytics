            ...
            {forms.length === 0 ? (
              ...
              <div className='grid gap-6'>
                {forms.map(form => (
                  <div
                    key={form.id}
                    className='bg-white/80 backdrop-blur-sm dark:bg-gray-800/90 dark:backdrop-blur-sm rounded-2xl shadow-xl border border-emerald-200/50 dark:border-emerald-700/30 hover:border-emerald-300 dark:hover:border-emerald-500 hover:shadow-2xl hover:shadow-emerald-500/20 dark:hover:shadow-emerald-500/10 p-8 transition-all duration-300 hover:bg-white/95 dark:hover:bg-gray-800/95'
                  >
                    <div className='flex items-center justify-between'>
