        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20'>
          <div className='text-center'>
            ...
            <p className='text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8'>
              Create, edit, and share professional forms with real-time
              analytics, trend insights, and intelligent data protection
            </p>
            ...
            <div>
              ...
              <ul className='space-y-4'>
                ...
                <li className='flex items-start'>
                  ...
                  <span className='text-gray-700 dark:text-gray-300'>
                    <strong>Export Capabilities</strong> - Download responses
                    and analytics data as CSV and PDF files
                  </span>
                </li>
                <li className='flex items-start'>
                  <svg
