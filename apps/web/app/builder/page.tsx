...
export default function FormBuilderPage() {
  ...
  const headerActions = (
    <>
      ...
      {/* Compact Tab switcher - Consistent with Individual Builder */}
      ...
      {/* Compact Action buttons - Consistent with Individual Builder */}
      ...
      <div className='min-h-screen relative overflow-hidden'>
        ...
        <div className='relative z-10'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
            ...
            {/* Compact Page Header - Consistent with Individual Builder */}
            <div className='mb-8'>
