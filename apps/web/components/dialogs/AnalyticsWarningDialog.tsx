              ...
              <div className="mt-2" id="warning-dialog-description">
                  ...
                  {hasResponses && (
                    <>
                      ...
                      <span className="font-semibold text-gray-700 dark:text-gray-300">
                        {currentResponseCount} {currentResponseCount === 1 ? 'response' : 'responses'}
                      </span>
                      .{' '}
                    </>
                  )}
                ...
                <div className="mt-3 rounded-md bg-yellow-50 dark:bg-yellow-900/10 p-3">
                  <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1">
                    {analysis.incompatibleChanges.map((change, index) => (
                      <li key={`incompatible-${index}`} className="flex items-start">
                ...
                <div className="mt-4 rounded-md bg-blue-50 dark:bg-blue-900/10 p-3">
                  <p className="text-xs text-blue-800 dark:text-blue-200">
                    <strong>Tip:</strong> Consider exporting your current analytics data before proceeding if you need to keep a record.
                  </p>
                </div>
              </div>
            </div>
