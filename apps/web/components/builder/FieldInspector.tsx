    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className='space-y-4'>
        ...
        <div className='flex items-center'>
          ...
          />
          <label
            htmlFor={`required-${localField.id}`}
                ...
                <div className='ml-6 space-y-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg'>
                  ...
                  <div>
                    ...
                    >
                      ...
                      {(() => {
                        const triggerField = availableFields.find(
                          f => f.id === localField.visibility?.whenFieldId
                        );
                  ...
                  {/* Preview */}
                  {localField.visibility.whenFieldId &&
                    localField.visibility.value && (
                      <div className='text-xs text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-700 p-2 rounded border'>
                        ...
                        {(() => {
                          ...
                          if (
                            triggerField?.type === 'mcq' ||
                            triggerField?.type === 'checkbox'
                          ) {
                            const option = triggerField.options?.find(
                              opt => opt.id === localField.visibility?.value
                            );
      ...
      <div className='border-t border-gray-200 dark:border-gray-700 pt-4'>
        ...
        <div className='text-xs text-gray-500 dark:text-gray-400 space-y-1'>
          ...
          <div>
            Type: <span className='capitalize'>{localField.type}</span>
          </div>
